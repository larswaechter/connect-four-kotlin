...
class Storage(private val movesPlayed: Int) {
    ...
    companion object {
        ...
        fun getTableFilename(movesPlayed: Int): String =
                when (movesPlayed) {
                    in 1..3 -> "table_1_3.txt"
                    in 4..6 -> "table_4_6.txt"
                    in 7..9 -> "table_7_9.txt"
                    in 10..12 -> "table_10_12.txt"
                    in 13..15 -> "table_13_15.txt"
                    in 16..18 -> "table_16_18.txt"
                    in 19..21 -> "table_19_21.txt"
                    in 22..24 -> "table_22_24.txt"
                    in 25..27 -> "table_25_27.txt"
                    in 28..30 -> "table_28_30.txt"
                    in 31..33 -> "table_31_33.txt"
                    in 34..36 -> "table_34_36.txt"
                    in 37..39 -> "table_37_39.txt"
                    in 40..42 -> "table_40_42.txt"
                    else -> ""
                }
