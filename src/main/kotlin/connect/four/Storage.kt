...
class Storage(private val movesPlayed: Int) {
    ...
    companion object {
        ...
        fun getTableFilename(movesPlayed: Int): String =
                when (movesPlayed) {
                    in 1..3 -> "0_table_1_3.txt"
                    in 4..6 -> "1_table_4_6.txt"
                    in 7..9 -> "2_table_7_9.txt"
                    in 10..12 -> "3_table_10_12.txt"
                    in 13..15 -> "4_table_13_15.txt"
                    in 16..18 -> "5_table_16_18.txt"
                    in 19..21 -> "6_table_19_21.txt"
                    in 22..24 -> "7_table_22_24.txt"
                    in 25..27 -> "8_table_25_27.txt"
                    in 28..30 -> "9_table_28_30.txt"
